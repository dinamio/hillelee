        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="probootstrap-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item probootstrap-cta probootstrap-seperator"><a href="registration" class="nav-link">Sign up</a></li>
                            ...
                            <div class="form-bottom">
                                <form role="form" action="registration" method="post" class="registration-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" placeholder="Full name..." class="form-full-name form-control" id="form-full-name">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="form-login">Login</label>
                                        <input type="text" name="login" placeholder="Login..." class="form-login form-control" id="form-login">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    ${loginExist}
                                    <br/>
                                    <button type="submit" onclick="location.href='/registration'" class="btn">Sign me up!</button>
                                </form>
                            </div>
                        </div>
