                    ...
                    <div class="col-sm-offset-2 col-md-8">
                        <div class="form-box">
                            ...
                            <div class="form-bottom">
                                <form role="form" action="authentication" method="post" class="login-form">
                                    <div class="form-group">
                                        <label class="sr-only" for="form-login">Username</label>
                                        <input type="text" name="login" placeholder="Username..." class="form-login form-control" id="form-login">
                                    </div>
                                    <div class="form-group">
